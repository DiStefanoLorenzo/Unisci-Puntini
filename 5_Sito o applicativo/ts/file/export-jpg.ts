const outputEsportaImmagine_jpg = document.getElementById('esporta-immagine-jpg') as HTMLInputElement;

outputEsportaImmagine_jpg.addEventListener('click', function() {
// Seleziona l'elemento SVG da salvare
var svg = document.getElementById("drawingpage") as HTMLElement;
...
img.onload = function() {
  ...
  canvas.toBlob(function(blob:any) {
    ...
    link.download = "immagine.jpeg"; // o "immagine.jpg"

    // Simula un click sul link per scaricare il file
    link.click();
  }, "image/jpeg"); // o "image/jpeg"
};
});