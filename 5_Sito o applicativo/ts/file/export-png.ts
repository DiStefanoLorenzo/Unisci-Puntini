const outputEsportaImmagine_png = document.getElementById('esporta-immagine-png') as HTMLInputElement;

outputEsportaImmagine_png.addEventListener('click', function() {
...
img.onload = function() {
  ...
  canvas.toBlob(function(blob:any) {
    ...
    link.download = "immagine.png"; // o "immagine.jpg"
